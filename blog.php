                                    ...
                                    <article class="card article-card article-card-sm h-100">
                                        <a href="article.html">
                                            <div class="card-image">
                                                ...
                                                <img loading="lazy" decoding="async" src="/assets/blogImages/post/ls-2.jpg" alt="Post Thumbnail" class="w-100">
                                            </div>
                                        </a>
                                        <div class="card-body px-0 pb-0">
                                            <ul class="post-meta mb-2">
                                    ...
                                    <article class="card article-card article-card-sm h-100">
                                        <a href="article.html">
                                            <div class="card-image">
                                                ...
                                                <img loading="lazy" decoding="async" src="/assets/blogImages/post/cr-1.jpg" alt="Post Thumbnail" class="w-100">
                                            </div>
                                        </a>
                                        <div class="card-body px-0 pb-0">
                                            <ul class="post-meta mb-2">
                                    ...
                                    <article class="card article-card article-card-sm h-100">
                                        <a href="article.html">
                                            <div class="card-image">
                                                ...
                                                <img loading="lazy" decoding="async" src="/assets/blogImages/post/cr-2.jpg" alt="Post Thumbnail" class="w-100">
                                            </div>
                                        </a>
                                        <div class="card-body px-0 pb-0">
                                            <ul class="post-meta mb-2">
                                    ...
                                    <article class="card article-card article-card-sm h-100">
                                        <a href="article.html">
                                            <div class="card-image">
                                                ...
                                                <img loading="lazy" decoding="async" src="/assets/blogImages/post/post-4.jpg" alt="Post Thumbnail" class="w-100">
                                            </div>
                                        </a>
                                        <div class="card-body px-0 pb-0">
                                            <ul class="post-meta mb-2">
                                    ...
                                    <article class="card article-card article-card-sm h-100">
                                        <a href="article.html">
                                            <div class="card-image">
                                                ...
                                                <img loading="lazy" decoding="async" src="/assets/blogImages/post/post-8.jpg" alt="Post Thumbnail" class="w-100">
                                            </div>
                                        </a>
                                        <div class="card-body px-0 pb-0">
                                            <ul class="post-meta mb-2">
                                            ...
                                            <div class="widget-body">
                                                <ul class="widget-list">
                                                    ...
                                                    foreach ($categories as $cat) {
                                                        echo '<li><a href="?source=' . $cat->id . '">' . $cat->name . '<span class="ml-auto">(3)</span></a>
                                                    </li>';
                                                    }
                                                    ?>
